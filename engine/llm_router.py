...
def _load_yaml_config(config_path: str) -> dict:
    ...
    Caches the YAML configuration file reading to prevent repeated disk I/O
    and parsing overhead during LLMRouter instantiation.
    """
...
class LLMRouter:
    def __init__(self, config_path="config/models.yaml"):
        ...
        # ⚡ Uses cached config loader to avoid repeated file reads
        # Deepcopying to prevent mutable global state issues if mutated later.
        self.config = copy.deepcopy(_load_yaml_config(config_path))
